...
function SpringOscillator() {
    ...
    const physics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$spring$2d$physics$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSpringPhysics"])({
        mass: 0.5,
        k: 20,
        amplitude: 80,
        phase: 0
    ...
    const { params, setParams, isPlaying, setIsPlaying, time, timeRef, historyRef, calculateState, step, reset, derived } = physics;
    // Interaction Check
    const checkInteraction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((clientX, clientY)=>{
        ...
        // Check distance to mass center (approx radius 25px)
        const dist = Math.sqrt(Math.pow(x - massX, 2) + Math.pow(y - massY, 2));
        if (dist < 40) return true // Hit radius
        ;
        return false;
    }, [
        layout,
    ...
    const handlePointerMove = (e)=>{
        ...
        let delta = 0;
        // Calculate new position relative to equilibrium
        if (layout === "horizontal") {
        ...
        // Update Amplitude and Phase based on drag position
        // If delta is positive, Phase = 0, Amp = delta
        // If delta is negative, Phase = PI, Amp = abs(delta)
        const newAmp = Math.abs(delta);
        const newPhase = delta >= 0 ? 0 : Math.PI;
        // Clamp Amplitude to reasonable values (e.g., within screen bounds)
        const maxAmp = layout === "horizontal" ? width / 2 - 20 : height / 2 - 20;
        const clampedAmp = Math.min(Math.max(newAmp, 0), maxAmp);
        // Force time to 0 so we see the static displacement x = A * cos(phi)
        // This makes it feel like we are directly controlling the position
        timeRef.current = 0;
        // We update params directly
        setParams((prev)=>({
                ...prev,
                amplitude: clampedAmp,
                phase: newPhase
            }));
        // Clear history because we changed initial conditions
        historyRef.current = [];
    };
    ...
    const draw = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((ctx, t)=>{
        ...
        if (layout === "horizontal") {
            ...
            // Draw Mass
            ctx.fillStyle = isDragging ? "#60a5fa" : "#3b82f6"; // Highlight when dragging
            ctx.fillRect(massX - 25, centerY - 25, 50, 50);
            ctx.strokeStyle = isDragging ? "#93c5fd" : "#60a5fa";
            ...
            const deltaL_px = derived.deltaL0 * 100 * 1.5 // Scaling for visibility
            ;
            ...
            // Draw Mass
            ctx.fillStyle = isDragging ? "#60a5fa" : "#3b82f6";
            ctx.beginPath();
    ...
    const drawEnergyGraph = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((ctx)=>{
        ...
        const maxEnergy = 0.5 * params.k * Math.pow(params.amplitude / 100, 2);
        // Safely handle zero maxEnergy
        const yScale = maxEnergy > 0 ? h * 0.8 / maxEnergy : 1;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const render = ()=>{
            ...
            if (canvasRef.current && width > 0 && height > 0) {
                ...
                // Don't set style.width here, handled by CSS/container
                }
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ref: containerRef,
                        className: "bg-[#16213e] rounded-xl overflow-hidden border border-cyan-900/50 shadow-lg relative w-full h-[400px] touch-none",
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute top-2 right-2 text-xs text-gray-400 pointer-events-none select-none",
                                children: [
                                    layout === "horizontal" ? "Horizontal" : "Vertical",
                                    " • Drag mass to set Amplitude"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/components/experiments/spring-oscillator.tsx",
                                lineNumber: 416,
...
function SimplePendulum() {
    ...
    const traceRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])([]);
...
//# sourceMappingURL=_812549bf._.js.map