...
function HarmonicOscillation() {
    ...
    const draw = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((ctx, t)=>{
        ...
        if (showGraph.x) {
            drawCurve("#22d3ee", (wt)=>params.amplitude * Math.cos(omega * wt + params.phase));
        }
        if (showGraph.v) {
            drawCurve("#4ade80", (wt)=>-params.amplitude * omega * Math.sin(omega * wt + params.phase), 1 / omega);
        }
        if (showGraph.a) {
            drawCurve("#f87171", (wt)=>-params.amplitude * omega * omega * Math.cos(omega * wt + params.phase), 1 / (omega * omega));
        }
        if (showGraph.x) {
            ctx.strokeStyle = "#22d3ee";
            ctx.setLineDash([
...
const SoundWaveLab = ()=>{
    ...
    const [frequency, setFrequency] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    const [amplitude, setAmplitude] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    // 3. Môi trường & Vật lý
    ...
    const canvasTimeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    // Buffer data refs
    ...
    const freqDataRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(new Uint8Array(0)); // Vẫn giữ để tính Pitch (Tần số)
    const MEDIUMS = {
        air: {
            name: 'Không khí (20°C)',
            v: 343
...
function StandingWaves() {
    ...
    const [isPlaying, setIsPlaying] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [time, setTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    const [endType, setEndType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("fixed-fixed");
    const [params, setParams] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        frequency: 1,
        amplitude: 50,
        harmonic: 3
    ...
    const draw = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((ctx, t)=>{
        ...
        const getEnvelope = (relX)=>{
            return A * Math.abs(Math.sin(k * relX));
        };
        const getWaveY = (relX, time)=>{
...
;
function PhysicsLab() {
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("harmonic");
    const experiments = [
        {
            id: "harmonic",
            label: "Dao động điều hòa",
            component: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$experiments$2f$harmonic$2d$oscillation$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
        },
        {
            id: "spring",
            label: "Con lắc lò xo",
            component: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$experiments$2f$spring$2d$oscillator$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
        },
        {
            id: "pendulum",
            label: "Con lắc đơn",
            component: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$experiments$2f$simple$2d$pendulum$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
        },
        {
            id: "damped",
            label: "Dao động tắt dần",
            component: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$experiments$2f$damped$2d$oscillation$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
        },
        {
            id: "mechanical",
            label: "Sóng cơ",
            component: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$experiments$2f$mechanical$2d$waves$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
        },
        {
            id: "sound",
            label: "Sóng âm",
            component: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$experiments$2f$sound$2d$waves$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
        },
        {
            id: "interference",
            label: "Giao thoa sóng",
            component: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$experiments$2f$wave$2d$interference$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
        },
        {
            id: "standing",
            label: "Sóng dừng",
            component: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$experiments$2f$standing$2d$waves$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
        }
    ];
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                        ...
                        children: experiments.map((exp)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TabsContent"], {
                                value: exp.id,
                                className: "mt-0",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(exp.component, {}, void 0, false, {
                                    fileName: "[project]/components/physics-lab.tsx",
                                    lineNumber: 53,
                                    columnNumber: 15
                                }, this)
...
//# sourceMappingURL=_ec063376._.js.map